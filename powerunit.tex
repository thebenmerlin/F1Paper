...
\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{torque_curve_overlay.pdf}
\vspace{6cm} % Placeholder height
\caption{MGU-K Output Torque vs. ICE Torque Curve illustrating low-RPM Torque Fill Strategy (Placeholder).}
