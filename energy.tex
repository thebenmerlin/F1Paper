...
\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{efficiency_chain_diagram.pdf}
\vspace{4.5cm} % Placeholder height
\caption{Cascaded Efficiency Chain Block Diagram from Kinetic Recovery to Chemical Storage (Placeholder).}
...
\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{lap_energy_deployment.pdf}
\vspace{6cm} % Placeholder height
\caption{Software-Mapped Lap Energy Deployment vs. Kinetic Harvesting Matrix (Placeholder).}
