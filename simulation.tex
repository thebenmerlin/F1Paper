...
\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{speed_trace_monza.pdf}
\vspace{6cm} % Placeholder height
\caption{Speed trace over lap distance — Monza (MATLAB simulation placeholder).}
\label{fig:sim_speed}
\end{figure*}

\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{mgu_k_map.pdf}
\vspace{6cm} % Placeholder height
\caption{MGU-K deployment and harvesting map over lap distance (MATLAB simulation placeholder).}
\label{fig:sim_mgu}
\end{figure*}

\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{soc_trace_monza.pdf}
\vspace{5cm} % Placeholder height
\caption{Battery SOC trace over lap distance with 20\%/95\% limits marked (MATLAB simulation placeholder).}
\label{fig:sim_soc}
\end{figure*}

\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{ggg_ellipse_monza.pdf}
\vspace{6cm} % Placeholder height
\caption{GGG friction ellipse at 252 km/h and 360 km/h (MATLAB simulation placeholder).}
