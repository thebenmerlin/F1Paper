...
\begin{figure*}[h]
\centering
% \includegraphics[width=\textwidth]{thermal_architecture.pdf}
\vspace{6cm} % Placeholder height
\caption{Integrated Thermal Architecture Diagram demonstrating four independent cooling loops and their respective sidepod core packaging (Placeholder).}
